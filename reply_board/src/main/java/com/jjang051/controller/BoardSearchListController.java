...
public class BoardSearchListController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		total =  replyDao.getTotal(searchSelect,searchWord);  // 검색 글 갯수
		System.out.println("searchtotal==="+total);
		...
		replyList = replyDao.getAllList(searchSelect,searchWord,start,end);
