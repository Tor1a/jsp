...
<main>
	<div id="contents">
		...
		<form method="POST" action="update_member_action.jsp" id="join" class="form" name="signUp">
			<table border="1" class="tdLeft">
				...
				<tbody>
					<tr>
						<th>아이디 <span>*</span></th>
						<!-- <input type="text" name="userId" placeholder="아이디" value="<%=loggedMemberId %>" disabled> 데이터 안날라감-->
						<td><input type="text" name="userId" placeholder="아이디" value="<%=loggedMemberId %>" readonly></td>
					</tr>
					<tr>
